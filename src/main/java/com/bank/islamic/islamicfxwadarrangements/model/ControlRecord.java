package com.bank.islamic.islamicfxwadarrangements.model;
...
/**
 * The BIAN control record for this service domain: "Wad FX Arrangement Procedure".
 *
 ...
 * to its asset type (Wad FX Arrangement). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Wad FX Arrangement Procedure";
